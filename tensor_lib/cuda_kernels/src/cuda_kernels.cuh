...
void cuda_unflatten_array(Matrix* array, size_t out_count, size_t out_rows, size_t out_cols, Matrix* out_matrices);                                                      // Take an array and unflatten it into n same_dimension matrices
